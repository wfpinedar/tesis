\begin{appendix}
\chapter{Anexo: Figuras del Árbol de Objetivos y El Árbol de Problemas}\label{AnexoA}
\begin{figure}[!ht]
\centering
\includegraphics[width=16cm]{Kap3/Fig_Kap3/ArboldeProblemas.png} %height=8cm,
\caption[Árbol de Problemas]{Gráfica del Árbol de Problemas. Fuente: Propia}
\label{fig:ArProblem}
\end{figure}
...
\caption[Árbol de Objetivos]{Gráfica del Árbol de Objetivos. Fuente: Propia}
