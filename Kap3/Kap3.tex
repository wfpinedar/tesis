...
Para este Capitulo los objetivos has sido obtenidos partiendo de la definición del árbol de problemas que se presenta en la Figura(\ref{fig:ArProblem}), en la cual se define el Problema general, luego sus principales causas y para finalizar las subcausas. El árbol de problemas cumple la función de ser el punto de partida para la creación del árbol de objetivos visto en la Figura (\ref{fig:ArObjetivos}), que es finalmente el que proporciona tanto el objetivo general como los específicos para este capitulo y que posteriormente hará posible definir algunas de las actividades que estarán en el desarrollo de la metodología.\\

\section{Objetivo General}

\begin{itemize}
\item Diseñar, desarrollar e implementación de un software que permita un fácil acceso a algoritmos de procesamiento de datos satélitales del GNSS en formato RINEX.
\end{itemize}

\section{Objetivos específicos}
\begin{itemize}
\item Desarrollar una aplicación que no tenga costo alguno y de licencia libre, que permita procesamiento de datos GNSS en formato RINEX.\\
\item Seleccionar un algoritmo apropiado pala procesar datos, explicarlo teóricamente y que sea coherente con el desarrollo del software.\\
\item Desarrollar un software de tipo web, para facilitar el acceso a los usuarios y que la capacidad de procesamiento no dependa de estos.\\
\end{itemize}

\begin{figure}[H]
\centering
\includegraphics[width=16cm]{Kap3/Fig_Kap3/ArboldeProblemas.png} %height=8cm,
\caption[Árbol de Problemas]{Gráfica del Árbol de Problemas}
\label{fig:ArProblem}
\end{figure}
...
\caption[Árbol de Objetivos]{Gráfica del Árbol de Objetivos}
