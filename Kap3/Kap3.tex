...
No solo las investigaciones que lleven a cabo las instituciones sino también se desea enfatizar en el aspecto de la docencia y las investigación docente, los cuales muchas veces se ven forzados a hacer uso de software de difícil acceso y que no les permite hacer una personalización total de los parámetros de entrada de sus procesamientos. Aspecto por el cual las investigaciones se pueden ser limitadas a un rango determinado de variables y condiciones impuestas por dichos programas.\\

Los estudiantes que asta ahora empiezan en el procesamiento de datos Rinex verán en esta herramienta la facilidad de poder dedicar su tiempo al entendimiento de la teoría y la explicació de fenomenos a partir de la misma. Porque se pretende que la aplicación sea amigable y que el usuario bno tenga que preocuparse de la legalidad o de las capacidades de sus estaciones de trabajo.  
