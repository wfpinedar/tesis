...
El desarrollo de una aplicación web para realizar el procesamiento de datos satelitales en formato RINEX mediante la técnica denominada \textit{procesamiento por punto preciso}, que permita un fácil acceso y manejo amigable para los usuarios es una necesidad que se ha hecho primordial en el mercado de las soluciones para el procesamiento de datos y objetivo fundamental del presente proyecto.

\section{Objetivo General}

\begin{itemize}
\item Diseñar, desarrollar e implementar un software que permita un fácil acceso al procesamiento de datos satelitales del GNSS en formato RINEX.
\end{itemize}

\section{Objetivos específicos}
\begin{itemize}
\item Establecer las condiciones para una aplicación que no tenga costo alguno y de licencia libre, que permita procesamiento de datos GNSS en formato RINEX.\\
\item Seleccionar un algoritmo apropiado para procesar datos satelitales, explicación teórica del mismo y búsqueda de coherencia del algoritmo con el desarrollo del software.\\
...
Primero que todo es necesario definir las hipótesis para poder realizar una comparación posterior con los resultados obtenidos, de esta manera realiza una ponderación de los resultados. las hipótesis iniciales se listan a continuación:\\

\begin{enumerate}
\item La creación de una aplicación para procesamiento de datos satelitales en formato RINEX, que permita acceso a la misma en linea, que no tenga asociado costo alguno y que ademas proporcione acceso al código fuente para que pueda ser mejorada por medio de forks. Generaria un aumento en la utilización de alternativas libres y ademas de eso mejores herramientas de fácil acceso para los actores de las comunidades científicas que basan sus estudios en el procesamiento de satos RINEX. 
\item Un algoritmo que permita obtener los mejores resultados en cuanto a una mejor precisión en el procesamiento de los datos, que este totalmente explicado en sus aspectos teóricos y que ademas este implementado en una plataforma que permita mejorarlo haciendo inclusión o cambios en las variable que necesita. Seria claramente una mejora en los procesos de investigación sobre modelos de carga oceánica y carga lunar.
\item Al desarrollar una aplicación que sea de acceso en linea que permita a los usuarios procesar sus datos sin que la carga del proceso recaiga sobre sus equipos, generaría un aumento paulatino en el interés de los usuarios que requieren procesar datos satelitales.  
\end{enumerate}

Teniendo estas hipótesis iniciales se deben hacer las pruebas pertinentes sobre el sistema para poder determinar si se cumplen, lo cual proporcionara como resultado la bondad del proceso de la aplicación. En el desarrollo del proyecto también es necesario definir las estrategias que serán usadas para el fin de comprobar estas hipótesis.\\

\chapter{Justificación}

Con el fin de proporcionar una nueva alternativa para el procesamiento de datos en formato Rinex se desea realizar el presente proyecto. Las mejoras que el proyecto tendrá sobre las alternativas existentes en el mercado actual serán adiciones como la opción de personalizar los insumos que se ingresan al programa por parte del usuario, no solo los datos y las efemérides.\\

También es menester realizar este proyecto como una forma de facilitar el acceso a las instituciones que se dedican a investigación referente a los datos de satélites, sus órbitas y las condiciones del entorno que pueden afectar las señales que estos emiten.\\

La investigación es uno de los procesos que se pretende facilitar con el desarrollo de esta aplicación, dado hacer uso de software difícil de acceder y que no les permite hacer una personalización total de los parámetros ingresados en sus procesamientos es uno de los problemas mas habituales que tienen que enfrentar este grupo de usuarios dedicados a la academia. Aspecto por el cual las investigaciones se pueden ser limitadas a un rango determinado de variables y condiciones impuestas por dichos programas.\\

Facilitar el acceso al procesamiento de datos Rinex a los usuarios que hasta ahora empiezan a desempeñarse en esta área, estos verán en la herramienta una facilidad de poder dedicar su tiempo al entendimiento de la teoría y la explicación de fenómenos a partir de la misma. Porque el proyecto pretende que la aplicación sea amigable y que el usuario no se vea en la necesidad que preocuparse de la legalidad o de las capacidades de sus estaciones de trabajo.  
