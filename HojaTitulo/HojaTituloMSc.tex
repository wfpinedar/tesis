...
Desarrollo de una aplicación web para procesamiento de datos satelitales mediante la técnica denominada \textquotedblleft procesamiento por punto preciso\textquotedblright.}\\[4.0cm]
\Large\textbf{Wilmar Fernando Pineda Rojas}\\
20071025074\\[4.0cm]
...
Desarrollo de una aplicación web para procesamiento de datos satelitales mediante la técnica denominada \textquotedblleft procesamiento por punto preciso\textquotedblright.}\\[2.0cm]
\Large\textbf{Wilmlar Fernando Pineda Rojas}\\
20071025074\\[2.0cm]
...
Director:\\
Ph.D., Rubén Javier Medina Daza\\[2.0cm]
%L\'{\i}nea de Investigaci\'{o}n:\\
%Nombrar la l\'{\i}nea de investigaci\'{o}n en la que enmarca la tesis  o trabajo de investigaci\'{o}n\\
Grupo de Investigaci\'{o}n:\\
Grupo GNU/Linux de La Universidad Distrital - Semillero En Tecnología Libre\\[2.5cm]
\small Universidad Distrital Francisco José de Caldas\\
Ingeniería Catastral y Geodesia\\
Bogotá D.C., Colombia\\
2014\\
