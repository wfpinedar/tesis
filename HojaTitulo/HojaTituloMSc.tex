...
Desarrollo de una aplicación web que permite ejecutar algoritmos de procesamiento de datos satélitales, para procesar datos mediante la técnica de punto preciso.}\\[4.0cm]
...
Desarrollo de una aplicación web que permite ejecutar algoritmos de procesamiento de datos satélitales, para procesar datos mediante la técnica de punto preciso.}\\[2.0cm]
...
Director(a):\\
Ph.D., Msc., Matemático., Ruben Javier Medina Daza\\[2.0cm]
